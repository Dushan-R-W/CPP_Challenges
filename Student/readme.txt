...
This project Implements a simple student management system. 
It allows to add a student, view student, search by ID, sort by ID, sort by name, save students to a .txt file and load saved data
